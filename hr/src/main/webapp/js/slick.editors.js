...
(function($) {
    ...
    var slickgrid_path = "js/vendor/slickgrid"
    ...
    var SlickEditor = {
        ...
        BoolCellFormatter : function(row, cell, value, columnDef, dataContext) {
            return value ? "<img src='"+slickgrid_path+"'/images/tick.png'>" : "";
        },
        ...
        TaskNameFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            return spacer + " <img src='"+slickgrid_path+"'/images/expand.gif'>&nbsp;" + value;
        },
        ...
        ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            if (columnDef.width < 50)
                return (resources.length > 1 ? "<center><img src='"+slickgrid_path+"'/images/user_identity_plus.gif' " : "<center><img src='"+slickgrid_path+"'/images/user_identity.gif' ") +
        ...
        StarFormatter : function(row, cell, value, columnDef, dataContext) {
            return (value) ? "<img src='"+slickgrid_path+"'/images/bullet_star.png' align='absmiddle'>" : "";
        },
        ...
        DateCellEditor : function(args) {
            ...
            this.init = function() {
                ...
                $input.datepicker({
                    ...
                    buttonImage: slickgrid_path+"/images/calendar.gif",
        ...
        StarCellEditor : function(args) {
            ...
            this.init = function() {
                $input = $("<IMG src='"+slickgrid_path+"'/images/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />")
